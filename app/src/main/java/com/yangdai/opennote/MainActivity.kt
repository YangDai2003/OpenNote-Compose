    ...
    override fun onProvideKeyboardShortcuts(
        ...
        val noteEdit = KeyboardShortcutGroup(
            ...
            listOf(
                ...
                KeyboardShortcutInfo(getString(R.string.italic), KeyEvent.KEYCODE_I, KeyEvent.META_CTRL_ON),
                KeyboardShortcutInfo(getString(R.string.underline), KeyEvent.KEYCODE_U, KeyEvent.META_CTRL_ON),
                KeyboardShortcutInfo(getString(R.string.strikethrough), KeyEvent.KEYCODE_D, KeyEvent.META_CTRL_ON),
                KeyboardShortcutInfo(getString(R.string.mark), KeyEvent.KEYCODE_M, KeyEvent.META_CTRL_ON),
                KeyboardShortcutInfo(getString(R.string.table), KeyEvent.KEYCODE_T, KeyEvent.META_CTRL_ON),
                KeyboardShortcutInfo(getString(R.string.link), KeyEvent.KEYCODE_K, KeyEvent.META_CTRL_ON),
                KeyboardShortcutInfo(getString(R.string.scan), KeyEvent.KEYCODE_S, KeyEvent.META_CTRL_ON),
                KeyboardShortcutInfo(getString(R.string.preview), KeyEvent.KEYCODE_P, KeyEvent.META_CTRL_ON),
